...
public class Simon{
    ...
    ArrayList<Integer>pattern=new ArrayList<Integer>();//This is the pattern of 0,1,2,3 that determines which if the colours needs to be clicked
    int complexity,clicks,tickcount;//Complexity is the total amount of times the colour will flash, Clicks keeps up to date with how many times the user has clicked colours to keep up with the pattern
    int[]invert; //This makes the inverted effect that the reader of the manual has to tell the person to click (So maybe 1 or like red has to actually be 3 AKA green)
    ...
    *Returns a boolean so that if they make a mistake, we can return false in the main and display the mistake.
    ...
    public void pattern(Graphics g){
